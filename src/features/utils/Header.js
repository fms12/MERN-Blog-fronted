          ...
          <div className="relative px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
            ...
            <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center ml-28">
              <div className="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0 ">
                <Link
                  to={"/login"}
                  className="flex items-center justify-center rounded-full border border-transparent bg-black px-4 py-3 text-base font-medium text-white shadow-sm sm:px-8"
                >
                  Start Reading
                </Link>
              </div>
